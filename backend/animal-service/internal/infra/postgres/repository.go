...
SELECT
	...
	animals.visibility,
	animals.boosted,
	animals.boost_expires_at,
	animals.audit_created_at,
	animals.audit_updated_at,
	animals.audit_created_by,
	animals.audit_updated_by,
	animals.donation_count,
	animals.interest_count
FROM animals`
